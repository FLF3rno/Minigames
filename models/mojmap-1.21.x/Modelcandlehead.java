...
public class Modelcandlehead<T extends candlehead> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "candlehead"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = waist.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(16, 17)
						.addBox(-4.0F, -5.3271F, -3.0114F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(38, 0)
						.addBox(-4.5F, -5.3271F, -3.5114F, 9.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -6.2045F, 1.0471F));

		PartDefinition cube_r1 = Body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(2, 2).addBox(-0.5F, -2.0F, 0.0F, 1.0F, 1.0F, 0.0F,
		...
		PartDefinition cube_r3 = Body.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(8, 28).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 1)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(8, 28)
						.addBox(-1.0F, -13.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 28)
						.addBox(-2.0F, -11.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(8, 28)
						.addBox(1.2F, -12.075F, -1.025F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 28)
						.addBox(-3.1F, -12.075F, -1.025F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 28)
						.addBox(-3.3F, -11.375F, 1.375F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 28)
						.addBox(-3.3F, -11.375F, -3.325F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 28)
						.addBox(-3.1F, -9.375F, -3.725F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 28)
						.addBox(-0.1F, -9.875F, -3.725F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 28)
						.addBox(2.7F, -9.475F, -3.625F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(8, 28)
						.addBox(-3.55F, -9.475F, -3.825F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(8, 28)
						.addBox(-3.675F, -9.175F, -0.925F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(9, 29)
						.addBox(-3.575F, -9.45F, 1.6F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 28)
						.addBox(2.675F, -9.175F, -0.925F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(10, 30)
						.addBox(2.7F, -9.575F, 2.075F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 28)
						.addBox(1.4F, -11.375F, -3.325F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 28)
						.addBox(1.4F, -11.375F, 1.375F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 28)
						.addBox(-1.0F, -12.075F, 1.175F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 28)
		...
		PartDefinition cube_r10 = Head.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(2, 2).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r20 = Head.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(9, 29).addBox(-1.5F, -1.5F, -1.0F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.65F, -8.05F, 2.725F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r21 = Head.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(9, 29).addBox(-1.5F, -1.5F, -1.0F, 3.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r29 = Head.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(2, 2).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -13.5F, 0.0F, 0.0F, 2.3562F, 0.0F));

		PartDefinition cube_r30 = Head.addOrReplaceChild("cube_r30",
				CubeListBuilder.create().texOffs(2, 2).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -13.5F, 0.0F, 0.0F, 0.7854F, 0.0F));

		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(40, 17)
				.addBox(-1.0F, -2.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-5.0F, 2.0F, 0.0F));

		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(0, 17)
