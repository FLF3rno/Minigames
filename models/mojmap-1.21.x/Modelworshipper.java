...
public class Modelworshipper<T extends worshipper> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "worshipper"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = waist.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(16, 16).addBox(-4.0F,
				-5.3271F, -4.5114F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -6.2044F, 1.0471F));
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(40, 16).mirror()
						...
						.texOffs(34, 17).addBox(-0.8F, 7.0F, -14.4F, 1.0F, 2.0F, 15.0F, new CubeDeformation(0.0F))
						.texOffs(58, 4).addBox(-0.825F, 3.6F, -11.4F, 1.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(5.0F, 2.0F, 0.0F));
