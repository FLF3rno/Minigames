...
public class HealthBar {
    private static final TagKey<EntityType<?>> DUNGEON_TAG = TagKey.create(
            ...
            ResourceLocation.fromNamespaceAndPath("minigames", "dungeon")
    );
    ...
    public static void onRenderLevelStage(RenderLevelStageEvent.AfterEntities event) {
        ...
        for (LivingEntity entity : mc.level.getEntitiesOfClass(
            ...
            if (!entity.getType().is(DUNGEON_TAG)) continue;
    ...
    private static void renderBar(Matrix4f matrix, LivingEntity entity, float health, float maxHealth) {
        ...
        VertexConsumer bgConsumer = buffers.getBuffer(RenderType.debugQuads());
