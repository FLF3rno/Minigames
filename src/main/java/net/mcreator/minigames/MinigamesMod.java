...
import net.mcreator.minigames.init.*;
...
public class MinigamesMod {
	public static final Logger LOGGER = LogManager.getLogger(MinigamesMod.class);
	public static final String MODID = "minigames";

	public MinigamesMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		MinigamesModSounds.REGISTRY.register(modEventBus);
		MinigamesModBlocks.REGISTRY.register(modEventBus);
		MinigamesModBlockEntities.REGISTRY.register(modEventBus);
		MinigamesModItems.REGISTRY.register(modEventBus);
		MinigamesModEntities.REGISTRY.register(modEventBus);
		MinigamesModTabs.REGISTRY.register(modEventBus);
		...
		net.mcreator.minigames.init.MinigamesModCustomParticleTypes.REGISTRY.register(modEventBus);
