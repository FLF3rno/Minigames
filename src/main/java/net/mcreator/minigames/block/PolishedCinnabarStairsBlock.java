...
public class PolishedCinnabarStairsBlock extends StairBlock {
	public PolishedCinnabarStairsBlock(BlockBehaviour.Properties properties) {
		super(Blocks.AIR.defaultBlockState(),
				properties.sound(new DeferredSoundType(1.0f, 1.0f, () -> BuiltInRegistries.SOUND_EVENT.getValue(Identifier.parse("minigames:update_cinnabar_break")),
