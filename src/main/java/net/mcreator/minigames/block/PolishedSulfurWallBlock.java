...
public class PolishedSulfurWallBlock extends WallBlock {
	public PolishedSulfurWallBlock(BlockBehaviour.Properties properties) {
		super(properties.sound(new DeferredSoundType(1.0f, 1.0f, () -> BuiltInRegistries.SOUND_EVENT.getValue(Identifier.parse("minigames:update_sulfur_break")),
				...
				() -> BuiltInRegistries.SOUND_EVENT.getValue(Identifier.parse("minigames:update_sulfur_hit")), () -> BuiltInRegistries.SOUND_EVENT.getValue(Identifier.parse("entity.generic.big_fall")))).strength(1f, 10f).forceSolidOn());
	}
}