...
public class MinigameGUIAchievementHuntScreen extends AbstractContainerScreen<MinigameGUIAchievementHuntMenu> implements MinigamesModScreens.ScreenAccessor {
	...
	private static final ResourceLocation IMAGE_5 = ResourceLocation.parse("minigames:textures/screens/clock.png");
	private static final ResourceLocation IMAGE_6 = ResourceLocation.parse("minigames:textures/screens/diamond_sword.png");
	private static final ResourceLocation IMAGE_7 = ResourceLocation.parse("minigames:textures/screens/halfextraslot.png");
	private static final ResourceLocation IMAGE_8 = ResourceLocation.parse("minigames:textures/screens/halfextraslot.png");
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		hunter.render(guiGraphics, mouseX, mouseY, partialTicks);
	...
	public boolean keyPressed(int key, int b, int c) {
		...
		if (hunter.isFocused())
			return hunter.keyPressed(key, b, c);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.minigames.minigame_gui_achievement_hunt.label_achievement_run"), -90, -20, -12829636, false);
	}

	@Override
	public void init() {
		super.init();
		hp = new EditBox(this.font, this.leftPos + 182, this.topPos + 72, 47, 18, Component.translatable("gui.minigames.minigame_gui_achievement_hunt.hp"));
		...
		hunter = new EditBox(this.font, this.leftPos + 27, this.topPos + 122, 118, 18, Component.translatable("gui.minigames.minigame_gui_achievement_hunt.hunter"));
