...
public class MagmaDartProjectileRenderer extends EntityRenderer<MagmaDartProjectileEntity, LivingEntityRenderState> {
	private static final ResourceLocation texture = ResourceLocation.parse("minigames:textures/entities/magmadartproj.png");
	private final Modeldart model;

	public MagmaDartProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
	...
	@Override
	public void extractRenderState(MagmaDartProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
