...
public class FightDoorsRenderer implements BlockEntityRenderer<FightDoorsBlockEntity> {
	...
	private void updateRenderState(FightDoorsBlockEntity blockEntity, float partialTick) {
		int tickCount = (int) blockEntity.getLevel().getGameTime();
		renderState.ageInTicks = tickCount + partialTick;
	}

	@Override
	public void render(FightDoorsBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource renderer, int light, int overlayLight, Vec3 cameraPos) {
