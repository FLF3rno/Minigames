...
public class SprucePewRightRenderer implements BlockEntityRenderer<SprucePewRightBlockEntity> {
	...
	private void updateRenderState(SprucePewRightBlockEntity blockEntity, float partialTick) {
		int tickCount = (int) blockEntity.getLevel().getGameTime();
		renderState.ageInTicks = tickCount + partialTick;
	}

	@Override
	public void render(SprucePewRightBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource renderer, int light, int overlayLight, Vec3 cameraPos) {
