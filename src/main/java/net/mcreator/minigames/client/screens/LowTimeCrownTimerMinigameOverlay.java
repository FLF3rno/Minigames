...
public class LowTimeCrownTimerMinigameOverlay {
	private static final ResourceLocation SPRITE_0 = ResourceLocation.parse("minigames:textures/screens/stasistimer.png");
	private static final ResourceLocation SPRITE_1 = ResourceLocation.parse("minigames:textures/screens/stasistimer.png");
	private static final ResourceLocation SPRITE_2 = ResourceLocation.parse("minigames:textures/screens/stasistimer.png");
	private static final ResourceLocation SPRITE_3 = ResourceLocation.parse("minigames:textures/screens/stasistimer.png");
	private static final ResourceLocation SPRITE_4 = ResourceLocation.parse("minigames:textures/screens/stasistimer.png");
	private static final ResourceLocation SPRITE_5 = ResourceLocation.parse("minigames:textures/screens/stasistimer.png");
	private static final ResourceLocation SPRITE_6 = ResourceLocation.parse("minigames:textures/screens/stasistimer.png");
	private static final ResourceLocation SPRITE_7 = ResourceLocation.parse("minigames:textures/screens/stasistimer.png");
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (ShowLowCrownTimerProcedure.execute(world)) {
