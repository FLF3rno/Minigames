...
public class VotePopupOverlay {
    private static final Identifier IMAGE_0 = Identifier.parse("minigames:textures/screens/voteno.png");
    private static final Identifier IMAGE_1 = Identifier.parse("minigames:textures/screens/voteyes.png");
    private static final Identifier SPRITE_0 = Identifier.parse("minigames:textures/screens/voteicons.png");
    ...
    public static void eventHandler(RenderGuiEvent.Pre event) {
        ...
        if (ShowVoteProcedure.execute(world)) {
            ...
            event.getGuiGraphics().text(minecraft.font, Component.literal(playerName), nameBaseX, nameY, playerNameColor, false);
            int messageX = (w - minecraft.font.width(voteMessage)) / 2;
            Component voteMessageComponent = Component.literal(voteMessage);
            event.getGuiGraphics().text(minecraft.font, voteMessageComponent, messageX - 1, messageY, 0xFFFFFFFF, false);
            event.getGuiGraphics().text(minecraft.font, voteMessageComponent, messageX + 1, messageY, 0xFFFFFFFF, false);
            event.getGuiGraphics().text(minecraft.font, voteMessageComponent, messageX, messageY - 1, 0xFFFFFFFF, false);
            event.getGuiGraphics().text(minecraft.font, voteMessageComponent, messageX, messageY + 1, 0xFFFFFFFF, false);
            event.getGuiGraphics().text(minecraft.font, Component.literal(voteMessage), messageX, messageY, 0xFF000000, false);
            event.getGuiGraphics().text(minecraft.font, voteYesKeybind, leftButtonX + (28 - minecraft.font.width(voteYesKeybind)) / 2, popupCenterY + 5, 0xFF000000, false);
            event.getGuiGraphics().text(minecraft.font, voteNoKeybind, rightButtonX + (28 - minecraft.font.width(voteNoKeybind)) / 2, popupCenterY + 5, 0xFF000000, false);
    ...
    private static Identifier getSkinTexture(PlayerSkin skin) {
