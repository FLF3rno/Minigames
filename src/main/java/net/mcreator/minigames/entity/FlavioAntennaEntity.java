...
public class FlavioAntennaEntity extends Monster {
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(FlavioAntennaEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> ANIM = SynchedEntityData.defineId(FlavioAntennaEntity.class, EntityDataSerializers.INT);

	public FlavioAntennaEntity(EntityType<FlavioAntennaEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "flavio_antenna");
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.getValue(Identifier.parse("block.netherite_block.hit"));
	}
	...
	public void readAdditionalSaveData(ValueInput valueInput) {
		...
		this.setTexture(valueInput.getStringOr("Texture", "flavio_antenna"));
	}

	@Override
	public void baseTick() {
		super.baseTick();
		AntennaTickProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
