...
import net.mcreator.minigames.procedures.SweeperTickProcedure;
...
public class FlavioSweeperEntity extends Monster {
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(FlavioSweeperEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> ANIM = SynchedEntityData.defineId(FlavioSweeperEntity.class, EntityDataSerializers.INT);
	public final AnimationState animationState0 = new AnimationState();

	public FlavioSweeperEntity(EntityType<FlavioSweeperEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "sweeper");
	...
	public void readAdditionalSaveData(ValueInput valueInput) {
		...
		this.setTexture(valueInput.getStringOr("Texture", "sweeper"));
	}
	...
	public void tick() {
		...
		if (this.level().isClientSide()) {
			if (this.animationState0.isStarted()) {
				...
				if (elapsedSeconds >= flavio_sweeperAnimation.spin.lengthInSeconds()) {
					if (!flavio_sweeperAnimation.spin.looping())
						this.animationState0.stop();
					else
						this.animationState0.start(this.tickCount);
				}
	...
	public void baseTick() {
		super.baseTick();
		SweeperTickProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
