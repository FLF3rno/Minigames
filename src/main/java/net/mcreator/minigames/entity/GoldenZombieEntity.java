...
public class GoldenZombieEntity extends Zombie {
	...
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(GoldenZombieEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> ANIM = SynchedEntityData.defineId(GoldenZombieEntity.class, EntityDataSerializers.INT);
	...
	public GoldenZombieEntity(EntityType<GoldenZombieEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("King Zombie"));
	...
	public void readAdditionalSaveData(ValueInput valueInput) {
		...
		this.setTexture(valueInput.getStringOr("Texture", "zombie"));
	}
