...
public class PreachingShotEntity extends AbstractArrow implements ItemSupplier {
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		PreachingShotHitProcedure.execute(this.level(), entityHitResult.getEntity(), this, this.getOwner());
	}
	...
	public static PreachingShotEntity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 1f, 5, 0);
	}

	public static PreachingShotEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 1f, 5, 0);
	}

	public static PreachingShotEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		PreachingShotEntity entityarrow = new PreachingShotEntity(MinigamesModEntities.PREACHING_SHOT.get(), entity, world, null);
	...
	public static PreachingShotEntity shoot(LivingEntity entity, LivingEntity target) {
		PreachingShotEntity entityarrow = new PreachingShotEntity(MinigamesModEntities.PREACHING_SHOT.get(), entity, entity.level(), null);
