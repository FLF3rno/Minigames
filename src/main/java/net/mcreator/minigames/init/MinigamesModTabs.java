...
public class MinigamesModTabs {
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> DUNGEON_ITEMS = REGISTRY.register("dungeon_items",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.minigames.dungeon_items")).icon(() -> new ItemStack(MinigamesModItems.BLANK_LONG_SWORD.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(MinigamesModItems.SILENT_ASSASSIN.get());
				tabData.accept(MinigamesModItems.POWER_HARVESTER.get());
				tabData.accept(MinigamesModItems.PARASITE_SCYTHE.get());
				...
				tabData.accept(MinigamesModItems.CHOICE_BAG_WARRIOR.get());
				tabData.accept(MinigamesModItems.CHOICE_BAG_SUPPORT.get());
				tabData.accept(MinigamesModItems.CHOICE_BAG_THIEF.get());
			}).withSearchBar().build());
