...
public class HumanCannonballItem extends Item {
	public HumanCannonballItem(Item.Properties properties) {
		super(properties.stacksTo(1).fireResistant().attributes(ItemAttributeModifiers.builder()
				.add(MinigamesModAttributes.SALVAGE_VALUE, new AttributeModifier(ResourceLocation.fromNamespaceAndPath(MinigamesMod.MODID, "human_cannonball_0"), 35, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
				.add(MinigamesModAttributes.ABILITY_COOLDOWN, new AttributeModifier(ResourceLocation.fromNamespaceAndPath(MinigamesMod.MODID, "human_cannonball_1"), 400, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND).build()));
	}
