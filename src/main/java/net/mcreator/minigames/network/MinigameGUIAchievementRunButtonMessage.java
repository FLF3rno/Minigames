...
public record MinigameGUIAchievementRunButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	}, (RegistryFriendlyByteBuf buffer) -> new MinigameGUIAchievementRunButtonMessage(buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readInt()));

	@Override
	public Type<MinigameGUIAchievementRunButtonMessage> type() {
		return TYPE;
	}

	public static void handleData(final MinigameGUIAchievementRunButtonMessage message, final IPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		MinigamesMod.addNetworkMessage(MinigameGUIAchievementRunButtonMessage.TYPE, MinigameGUIAchievementRunButtonMessage.STREAM_CODEC, MinigameGUIAchievementRunButtonMessage::handleData);
	}
}