...
public class ImmobilizedMobEffect extends MobEffect {
	public ImmobilizedMobEffect() {
		...
		this.addAttributeModifier(Attributes.BLOCK_INTERACTION_RANGE, ResourceLocation.fromNamespaceAndPath(MinigamesMod.MODID, "effect.immobilized_0"), -10, AttributeModifier.Operation.ADD_VALUE);
		this.addAttributeModifier(Attributes.ENTITY_INTERACTION_RANGE, ResourceLocation.fromNamespaceAndPath(MinigamesMod.MODID, "effect.immobilized_1"), -10, AttributeModifier.Operation.ADD_VALUE);
