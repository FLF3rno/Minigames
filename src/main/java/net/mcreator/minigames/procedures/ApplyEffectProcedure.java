						...
						if (world.isClientSide()) {
							if (world instanceof Level _level) {
								if (!_level.isClientSide()) {
									_level.playSound(null, BlockPos.containing(entityiterator.getX(), entityiterator.getY(), entityiterator.getZ()), BuiltInRegistries.SOUND_EVENT.getValue(Identifier.parse("block.brewing_stand.brew")),
											SoundSource.PLAYERS, (float) 0.7, 2);
								} else {
									_level.playLocalSound((entityiterator.getX()), (entityiterator.getY()), (entityiterator.getZ()), BuiltInRegistries.SOUND_EVENT.getValue(Identifier.parse("block.brewing_stand.brew")), SoundSource.PLAYERS,
											(float) 0.7, 2, false);
								}
							}
						}
