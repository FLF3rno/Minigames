...
public class HorseshoeRightclickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (entity instanceof Player _player)
			_player.getCooldowns().addCooldown(itemstack, (int) GetItemAttributeProcedure.execute(itemstack, "minigames:effect_length"));
		ApplyEffectProcedure.execute(entity, false, GetItemAttributeProcedure.execute(itemstack, "minigames:effect_potency"), GetItemAttributeProcedure.execute(itemstack, "minigames:effect_length"), "minecraft:luck");
