...
public class SpawnFlavioTrapdoor2BlockAddedProcedure {
		...
		if ((getDirectionFromBlockState((world.getBlockState(BlockPos.containing(x, y, z))))) == Direction.SOUTH) {
			if (spawn == true) {
				...
				if (world instanceof ServerLevel _level) {
					Entity entityToSpawn = MinigamesModEntities.FLAVIO_TRAPDOOR_2.get().spawn(_level, BlockPos.containing(x, y, z), EntitySpawnReason.MOB_SUMMONED);
