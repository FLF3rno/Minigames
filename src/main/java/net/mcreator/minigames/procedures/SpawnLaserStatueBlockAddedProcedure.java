...
public class SpawnLaserStatueBlockAddedProcedure {
		...
		if ((getDirectionFromBlockState((world.getBlockState(BlockPos.containing(x, y, z))))) == Direction.SOUTH) {
			if (spawn == true) {
				...
				if (world instanceof ServerLevel _level) {
					Entity entityToSpawn = MinigamesModEntities.LASER_STATUE.get().spawn(_level, BlockPos.containing(x, y, z), EntitySpawnReason.MOB_SUMMONED);
