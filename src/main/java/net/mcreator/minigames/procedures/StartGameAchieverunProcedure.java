...
public class StartGameAchieverunProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (MinigamesModVariables.MapVariables.get(world).achievement != 43) {
			if (world instanceof ServerLevel _level)
				_level.getServer().getCommands().performPrefixedCommand(
						new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, LevelBasedPermissionSet.OWNER, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(), "/time set noon");
		} else {
			if (world instanceof ServerLevel _level)
				_level.getServer().getCommands().performPrefixedCommand(
		...
		if (MinigamesModVariables.MapVariables.get(world).achievmentType == 5 || MinigamesModVariables.MapVariables.get(world).achievement == 13 || MinigamesModVariables.MapVariables.get(world).achievement == 49
				|| MinigamesModVariables.MapVariables.get(world).achievement == 57) {
			if (world instanceof ServerLevel _level)
				_level.getServer().getCommands().performPrefixedCommand(
						...
						"/execute in minecraft:overworld run spreadplayers 0 0 10000 10000 under 200 true @a");
		}
		...
		if (world instanceof ServerLevel _level)
			_level.getServer().getCommands().performPrefixedCommand(
					...
					"/spreadplayers ~ ~ 3 4 under 300 false @a");
		if (world instanceof ServerLevel _level)
			_level.getServer().getCommands().performPrefixedCommand(
					new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, LevelBasedPermissionSet.OWNER, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
		...
		MinigamesMod.queueServerWork(20, () -> {
			...
			if (world instanceof ServerLevel _level)
				_level.getServer().getCommands().performPrefixedCommand(
						new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, LevelBasedPermissionSet.OWNER, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
						"/playsound minigames:countdown player @a ~ ~ ~ 10000000000 1");
		});
		...
		MinigamesMod.queueServerWork(80, () -> {
			...
			if (world instanceof ServerLevel _level)
				_level.getServer().getCommands().performPrefixedCommand(
						new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, LevelBasedPermissionSet.OWNER, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
						"/playsound minigames:start player @a ~ ~ ~ 10000000000 1");
			if (world instanceof ServerLevel _level)
				_level.getServer().getCommands().performPrefixedCommand(
						new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, LevelBasedPermissionSet.OWNER, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
						"/team modify teamold nametagVisibility always");
			MinigamesModVariables.MapVariables.get(world).displayTimer = true;
			MinigamesModVariables.MapVariables.get(world).markSyncDirty();
			if (MinigamesModVariables.MapVariables.get(world).achievementHunterMode == true && MinigamesModVariables.MapVariables.get(world).headStart == true) {
				if (world instanceof ServerLevel _level)
					_level.getServer().getCommands().performPrefixedCommand(
							new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, LevelBasedPermissionSet.OWNER, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
							(("/effect give @a[name=!" + (MinigamesModVariables.MapVariables.get(world).hunterAchievement + "] minigames:nerf_hunters ")) + ""
									+ (new java.text.DecimalFormat("##").format(MinigamesModVariables.MapVariables.get(world).debuffLength) + " 1 true")));
			}
		});
	}
}