...
public class VolleyBombDescriptionProcedure {
	public static String execute(ItemStack itemstack) {
		return "\n" + "\u00A76\u00A7lON RIGHT CLICK" + "\n" + "Summon and launch a big, slow bomb foreward" + "\n"
				...
				+ "\u00A76\u00A7l    WITH A PROJECTILE" + "\n" + ("     Detonates instantly dealing \u00A72" + new java.text.DecimalFormat("##.#").format(GetItemAttributeProcedure.execute(itemstack, "minigames:extra_damage")))
