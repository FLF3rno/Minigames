...
public class ClassSelectionRoguelikeMenu extends AbstractContainerMenu implements MinigamesModMenus.MenuAccessor {
	...
	public ClassSelectionRoguelikeMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinigamesModMenus.CLASS_SELECTION_ROGUELIKE.get(), id);
