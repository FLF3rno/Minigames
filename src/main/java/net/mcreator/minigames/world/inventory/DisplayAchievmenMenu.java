...
public class DisplayAchievmenMenu extends AbstractContainerMenu implements MinigamesModMenus.MenuAccessor {
	...
	public DisplayAchievmenMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinigamesModMenus.DISPLAY_ACHIEVMEN.get(), id);
