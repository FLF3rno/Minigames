...
public class FlavioPhase2Menu extends AbstractContainerMenu implements MinigamesModMenus.MenuAccessor {
	...
	public FlavioPhase2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinigamesModMenus.FLAVIO_PHASE_2.get(), id);
