...
@EventBusSubscriber
public class MinigameGUIAchievementHuntMenu extends AbstractContainerMenu implements MinigamesModMenus.MenuAccessor {
	...
	public MinigameGUIAchievementHuntMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinigamesModMenus.MINIGAME_GUI_ACHIEVEMENT_HUNT.get(), id);
