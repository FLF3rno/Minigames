...
import net.mcreator.minigames.procedures.DefaultAchievementRunSettingsProcedure;
...
@EventBusSubscriber
public class MinigameGUIAchievementRunMenu extends AbstractContainerMenu implements MinigamesModMenus.MenuAccessor {
	...
	public MinigameGUIAchievementRunMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinigamesModMenus.MINIGAME_GUI_ACHIEVEMENT_RUN.get(), id);
	...
	public static void onContainerOpen(PlayerContainerEvent.Open event) {
		...
		if (event.getContainer() instanceof MinigameGUIAchievementRunMenu menu) {
			Level world = menu.world;
			double x = menu.x;
			double y = menu.y;
			double z = menu.z;
			DefaultAchievementRunSettingsProcedure.execute(world, entity);
		}
	}
}