...
public class OptionCategoryMenu extends AbstractContainerMenu implements MinigamesModMenus.MenuAccessor {
	...
	public OptionCategoryMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinigamesModMenus.OPTION_CATEGORY.get(), id);
