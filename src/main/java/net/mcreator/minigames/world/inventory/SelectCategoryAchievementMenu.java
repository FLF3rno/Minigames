...
public class SelectCategoryAchievementMenu extends AbstractContainerMenu implements MinigamesModMenus.MenuAccessor {
	...
	public SelectCategoryAchievementMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinigamesModMenus.SELECT_CATEGORY_ACHIEVEMENT.get(), id);
