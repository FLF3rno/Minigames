...
public class StartGameMenu extends AbstractContainerMenu implements MinigamesModMenus.MenuAccessor {
	...
	public StartGameMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinigamesModMenus.START_GAME.get(), id);
