...
@EventBusSubscriber
public class ViewAchievmentMenu extends AbstractContainerMenu implements MinigamesModMenus.MenuAccessor {
	...
	public ViewAchievmentMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinigamesModMenus.VIEW_ACHIEVMENT.get(), id);
	...
	public static void onPlayerTick(PlayerTickEvent.Post event) {
		...
		if (entity.containerMenu instanceof ViewAchievmentMenu menu) {
